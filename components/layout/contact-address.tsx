      ...
      <div className="self-center gap-4 grid grid-cols-1 xl:grid-cols-3 w-full">
        ...
        >
          <div className="self-center flex flex-col items-center font-bold text-base sm:text-3xl text-primary">
            <div>Individuální terapie</div>
            <div>Jeseník</div>
          </div>
          <Image
            className="self-center rounded-full"
            src="/images/poliklinika-ordinace.webp"
            width={200}
            height={200}
        ...
        >
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2 text-primary">
              ...
              <a
                className="text-xl"
                href="https://maps.app.goo.gl/fApcgjqqxZJppNW4A"
                target="_blank"
              >
